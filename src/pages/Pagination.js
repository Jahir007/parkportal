...
const Pagination = ({pages, setCurrentPage, currentOwners, sortedOwners}) => {
    ...
    return (
        ...
        <div className="hint-text">Showing <b>{currentOwners.length}</b> out of <b>{sortedOwners.length}</b> entries</div>
